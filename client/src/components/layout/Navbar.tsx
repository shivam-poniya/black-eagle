    ...
    <nav className={cn(
      ...
      <div className="container mx-auto px-4 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-4 group cursor-pointer">
          ...
          <span className="text-[28px] font-bold font-heading tracking-tight leading-none">
            BLACK EAGLE
          </span>
        </Link>
        ...
        <div className="hidden lg:flex items-center gap-12">
          <div className="flex items-center gap-10">
            {navLinks.map((link) => (
              <Link 
                ...
                href={link.href}
                className={cn(
                  "text-[14px] font-black uppercase tracking-[0.2em] transition-all hover:text-primary cursor-pointer",
          ...
          <Link href="/contact" className="flex items-center">
            <Button className="rounded-full px-11 font-black uppercase tracking-widest text-[14px] h-13 bg-primary hover:bg-primary/90 cursor-pointer">
              Get Started
            </Button>
          </Link>
        </div>
